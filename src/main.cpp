...
// TODO (Marco): dit zorgt voor een seg fault - zal met de init in runapp en delwin in main te maken hebben
int main() {
    win header;
    ...
    header.window = newwin(header.height, header.width, header.ystart, header.xstart);
    ...
    my_pokemon_window.window = newwin(my_pokemon_window.height, my_pokemon_window.width,
    ...
    enemy_pokemon_window.window = newwin(enemy_pokemon_window.height, enemy_pokemon_window.width,
